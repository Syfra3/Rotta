...
- Phase 4 — Review: run the metrics-based review workflow. The Judge reviews evidence, not code. Resolve only the ` + "`rotta.quality-gates/v1 generic gate plan`" + ` from the recorded snapshot and persist current review evidence to ` + "`.rotta/current/review-evidence.yaml`" + `.
